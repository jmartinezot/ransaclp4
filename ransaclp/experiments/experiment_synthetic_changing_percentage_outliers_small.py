...
def run_experiments_and_save_results():
    ...
    and saves the mean segmentation times and inlier counts in /tmp/percentage_outliers_small.
    """
    # Ensure the output directory exists.
    out_dir = "/tmp/percentage_outliers_small"
...
def create_plot_from_saved_results():
    """
    Loads the experiment results from /tmp/percentage_outliers_small and creates
    ...
    axs[0].scatter(outlier_ratios, standard_times, marker='o', label="Standard RANSAC")
    axs[0].scatter(outlier_ratios, ransaclp_times, marker='o', label="RANSACLP")
    ...
    axs[1].scatter(outlier_ratios, standard_inliers, marker='o', label="Standard RANSAC")
    axs[1].scatter(outlier_ratios, ransaclp_inliers, marker='o', label="RANSACLP")
    ...
    plt.tight_layout()
    plot_save_path = os.path.join(out_dir, 'synthetic_changing_percentage_outiers_small.png')
