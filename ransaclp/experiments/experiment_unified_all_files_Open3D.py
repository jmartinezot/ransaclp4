...
def main():
    ...
    seed = 42
    results_dir = "/tmp/results_open3d_json"
    image_filename = "/tmp/results_open3d_json/shaffer_open3d.png"
    boxplot_filename = "/tmp/results_open3d_json/time_boxplots_open3d.png"
    ...
    if df_inliers.empty:
        ...
        plot_inlier_boxplots(df_inliers, "/tmp/results_open3d_json/inliers_boxplots_open3d.png")
