...
def main():
    ...
    image_filename = "/tmp/results_tecnalia_json/shaffer_tecnalia.png"
    boxplot_filename = "/tmp/results_tecnalia_json/time_boxplots_tecnalia.png"
    ...
    source_dir = "/tmp/Tecnalia_Lanverso_dataset/"
    ...
    if df_inliers.empty:
        ...
        plot_inlier_boxplots(df_inliers, "/tmp/results_tecnalia_json/inliers_boxplots_tecnalia.png")
