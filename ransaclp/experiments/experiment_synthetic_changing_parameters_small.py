...
def run_parameter_grid_experiments_and_save_results():
    ...
    running time and inlier count, and saves the results in /tmp/parameters_small.
    """
    out_dir = "/tmp/parameters_small"
...
def create_heatmap_from_saved_results():
    """
    Loads the experiment results from /tmp/parameters_small and creates heatmaps
    ...
    plt.savefig(plot_save_path, format='eps', dpi=30)
